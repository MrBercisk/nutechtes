...
class UserModel extends Model
{
	...
	protected $allowedFields = ['id','role_id', 'nama', 'email','position','password', 'image','role', 'created_at'];
	protected $column_search = ['nama', 'email', 'position',];
	protected $column_order = [null, 'nama', 'email', 'position', null];
